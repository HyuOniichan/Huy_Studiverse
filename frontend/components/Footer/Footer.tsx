            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                    ...
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-gray-900 font-medium mb-7">Studiverse</h4>
                        <ul className="text-sm  transition-all duration-500">
                            ...
                            <li className="mb-6"><Link href="/courses" className=" text-gray-600 hover:text-gray-900">Courses</Link></li>
                            <li className="mb-6"><Link href="/blogs" className=" text-gray-600 hover:text-gray-900">Blogs</Link></li>
                        </ul>
                    </div>
                    <div className="lg:mx-auto text-left ">
                ...
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-gray-500 ">No copyright. For personal use.</span>
